...
#define D2_CALLSIGN      "APRS"
#define D2_CALLSIGN_ID   0
...
#define APRS_PERIOD   60000UL
#define TWEET_PERIOD  5000UL
//#define DATA_PERIOD   1000UL

// Set any value here (in ms) if you want to delay the first transmission
// after resetting the device.
#define APRS_DELAY    2000UL
...
#define EXTERNALTEMPPOWERPIN     7
#define EXTERNALTEMPREADPIN      A1
#define PRESSUREPOWERPIN         2
#define PRESSUREREADPIN          A2
...
#define BUZZER_ALTITUDE         0.0  // meters (divide by 0.3048 for ft.)
